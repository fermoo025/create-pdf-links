let dic = {},
    invalidFiles = [];
//  1jwQ03EQ0O7Ofl8geDH21v1HXom8NNiH7
const FOLDER_ID = '1-VBQzExkHPLyq8iAZ9d5Q8eEbBE1REy7',
...
function common() {
    ...
    data.forEach((dat, index) => {
        let price = parseInt(toHalfWidth(dat[8]).trim().replace(/,/g, '')),
            fn = '',
            addr = dat[5].trim();
...
function matchPdfUsingINumericPrice2() {
    ...
    let allText = allFile.getBlob().getDataAsString();
    allText = convertNFC(allText);
